                  ...
                  meal.items.map(item => (
                    <div key={item.id} className="flex justify-between items-center bg-muted/50 p-2 rounded-md">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{item.serving} &bull; {item.calories.toFixed(0)} kcal</p>
                      </div>
                      <button onClick={() => onRemoveFood(meal.name, item.id)} className="text-muted-foreground hover:text-destructive p-1 rounded-full hover:bg-destructive/10">
